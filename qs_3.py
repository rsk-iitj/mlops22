...
f1_macro_score = f1_score(y_test, prediction,average="macro")
...
file_name = "results/"+clf_name+" "+str(rst)+".txt"
file = open(file_name, "w")
file.write("TestAccuracy :" + str(test_accuracy) + "\n" +"F1 Score Macro: "+str(f1_macro_score) )
file.close
filename = 'models/'+str(best_model)+".joblib"
